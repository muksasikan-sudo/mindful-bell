(() => {
  ...
  const defaults = {
    ...
    messages: [
      ...
      "มีสติรู้ทันจิต: เมื่อจิตหลงไปคิด ไปสุข ไปทุกข์ หรือโกรธ ให้มีสติรู้ทันความเปลี่ยนแปลงนั้น",
      "รู้ทันความเปลี่ยนแปลงของจิต จะพบการเกิดขึ้น ตั้งอยู่ และดับไป",
      ...
      "เมื่อจิตเกิดความปรุงแต่งต่อจากการนึกถึงเรื่องๆหนึ่ง จะเกิดชอบ หรือเกิดไม่ชอบขึ้นมา ให้เราก็มีสติรู้ทัน",
      "ไม่ว่าเราจะเจอสิ่งที่ดีหรือไม่ดีก็ตาม เราเลือกไม่ได้ กรรมมันส่งผลมาให้ เรามีหน้าต้องทำกรรมใหม่ที่ดี",
      "กระทบอารมณ์ จิตมีความเปลี่ยนแปลง ตีค่า แล้วก็เกิดยินดียินร้าย เกิดพอใจไม่พอใจขึ้นมา ให้รู้ทัน",
      "อยู่ๆ มันก็นึกถึง นึกถึงคนที่เราชอบ ใจเราก็มีความสุขขึ้นมา แล้วก็นึกต่อไปอีกช็อตหนึ่ง ตอนนี้ไปตกระกำลำบากอยู่ที่ไหน เป็นห่วงแล้ว จากจิตที่ชอบ จิตที่มีความสุขที่ได้นึกถึงคนที่เรารัก แล้วคนที่เรารักตอนนี้ไปอยู่ที่อื่น ช็อตต่อมา มันไม่ใช่รู้สึกมีความสุข มันรู้สึกกังวลว่าเขาจะอยู่อย่างไร เขาจะกินอย่างไร จะนอกใจเราไปหรือยังอะไรอย่างนี้ ใจมันปรุงต่อ ให้เราตามรู้ความเปลี่ยนแปลงของจิตใจตัวเองไป",
      "ไม่เพ่งและไม่ปล่อยลอย: ฝึกทำกรรมฐานโดยไม่บังคับจิตให้เคลิ้มหรือเพ่งนิ่งจนเกินไป แต่ให้รู้ตัวด้วยจิตที่ตั้งมั่น",
